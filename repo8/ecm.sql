...
-- Records of cart
-- ----------------------------
INSERT INTO `cart` VALUES ('C0001', ' ADM0001', 'P00009', 1);
INSERT INTO `cart` VALUES ('C0002', 'ADM0001', 'P00011', 1);
...
CREATE TABLE `log`  (
  ...
  `tanggal` datetime(0) NOT NULL DEFAULT '1000-01-01 00:00:00' ON UPDATE CURRENT_TIMESTAMP(0)
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
INSERT INTO `log` VALUES ('andaaree', '::1', 'Menambahkan produk P30 Pro', 'P00007', '2020-06-05 17:10:30');
INSERT INTO `log` VALUES ('andaaree', '::1', 'Menambahkan produk Realme 5 Pro', 'P00008', '2020-05-05 17:11:14');
INSERT INTO `log` VALUES ('andaaree', '::1', 'Menambahkan produk Galaxy S10', 'P00009', '2020-06-05 17:14:05');
INSERT INTO `log` VALUES ('andaaree', '::1', 'Menambahkan produk iPhone XR MAX', 'P00010', '2020-06-05 17:14:33');
...
INSERT INTO `log` VALUES ('andaaree', '::1', 'Menghapus brand Smartfren', 'V0007', '2020-06-06 10:08:11');
INSERT INTO `log` VALUES ('andaaree', '::1', 'Menghapus brand Evercoss', 'V0013', '2020-06-06 10:08:15');
...
-- ----------------------------
DROP TABLE IF EXISTS `product_delete`;
CREATE TABLE `product_delete`  (
  ...
  `product_vendor` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES ('ADM0001', 'andaaree', 'andaaree@gmail.com', '625bba720fcf26c8e9c45895e4ad8c97', 'active', '0');
INSERT INTO `users` VALUES ('U0001', 'andar', 'dwianjar.1998@gmail.com', '202cb962ac59075b964b07152d234b70', 'inactive', '1');
...
-- ----------------------------
DROP TRIGGER IF EXISTS `delete_prod`;
delimiter ;;
CREATE TRIGGER `delete_prod` AFTER DELETE ON `products` FOR EACH ROW BEGIN
