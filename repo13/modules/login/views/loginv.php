    ...
    <div class="card-body login-card-body">
      ...
      <form action="#" method="post">
        <div class="input-group mb-3">
          ...
          <div class="input-group-text"><?php echo form_error('username'); ?></div>
        ...
        <div class="input-group mb-3">
          ...
          <div class="input-group-text"><?php echo form_error('password'); ?></div>
          <div class="input-group-append">
            <div class="input-group-text">
      ...
      <span class="fas col-12"></span>
      <p class="mb-0">
      <p><?php echo anchor(site_url().'register/admin','Register a new account'); ?></p>
      <br>
        <p class="text-danger"><?php echo anchor(site_url().'','Home'); ?></p>
      </p>
    </div>
    <!-- /.login-card-body -->
  </div>
