$(function($) {
    $("#btn-search").click(function() {
        ...
        $.ajax({
            ...
            data: { keywords: $("#keywords").val() }, // Set data yang akan dikirim       
            dataType: "json",
            ...
            success: function(response) { // Ketika proses pengiriman berhasil
                ...
                $("#btn-search").html("SEARCH").removeAttr("disabled"); // Ganti isi dari div view dengan view yang diambil dari controller siswa function search
                $("#search-results").html(response.res);
            },
