    ...
    <section class="content">
      <div class="row">
        <div class="col-md-6">
          ...
          <form method="post" action="<?php echo base_url('')?>vendor/edit_vendor">
          <?php foreach ($edit as $ed):?>
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input type="text" name="catid" value="<?= $ed['vendor_id'] ?>" class="form-control" readonly>
              </div>
            </div>
            <div class="card-body">
              <div class="form-group">
                <label for="inputName">Vendor Name</label>
                <input type="text" name="catname" value="<?= $ed['vendor_name'] ?>" class="form-control">
              </div>
            </div>
            <div class="card-body">
              <div class="form-group">
